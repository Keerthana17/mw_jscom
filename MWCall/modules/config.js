...
JSCommSettings = {
  ...
  turn_servers: [
    ...
    { server:"turn:stun-test.sip5060.net", username: "test", password: "notasecret" }
    //{ server:"turns:stun-test.sip5060.net:443", username: "test", password: "notasecret" }
  ...
  user: {
    ...
    uri: 'sip:anonymous@freephonebox.net',
    sip_auth_user: 'anonymous',
    sip_auth_password: 'anonymous',
